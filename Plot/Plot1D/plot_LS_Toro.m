...
hxs1 = xline(xs(1), ':', 'Color', cShockL, 'LineWidth', 1.7);
hxs2 = xline(xs(2), ':', 'Color', cContact,'LineWidth', 1.7);
hxs3 = xline(xs(3), ':', 'Color', cShockR ,'LineWidth', 1.7);

ylabel("$\rho$","Interpreter","latex")
xlim([x1,x2]);
ylim([0,35])

legend([hLF; hxs1; hxs2; hxs3; h0], ...
    [ ...
    "$\rho_1$", ...
    "$\rho_2$", ...
    "$\rho_3$", ...
...
hxs1 = xline(xs(1), ':', 'Color', cShockL, 'LineWidth', 1.7);
hxs2 = xline(xs(2), ':', 'Color', cShockR, 'LineWidth', 1.7);
...
hxs12 = xline(ax2, xs(1), ':', ...
    'Color', cShockL, 'LineWidth', 1.7);
hxs22 = xline(ax2, xs(2), ':', ...
    'Color', cContact, 'LineWidth', 1.7);
hxs32 = xline(ax2, xs(3), ':', ...
    'Color', cShockR, 'LineWidth', 1.7);
...
legend(ax2, [hLF2; hxs12; hxs22; hxs32; h02], ...
    [ ...
    "$\rho_1$", ...
    "$\rho_2$", ...
    "$\rho_3$", ...
...
hLF3 = gobjects(thisNd+1,1);
for j = 1:thisNd+1
    hLF3(j) = plot(ax3, x, LF(:,j,vdx), ...
        'Color', lineColors(j,:), ...
        'LineWidth', 1.7);
end

h03 = plot(ax3, x, prim(vdx,:), '--', ...
    'Color', cGray, 'LineWidth', 1.4);

hxs13 = xline(ax3, xs(1), ':', ...
    'Color', cShockL, 'LineWidth', 1.7);
hxs23 = xline(ax3, xs(2), ':', ...
    'Color', cShockR, 'LineWidth', 1.7);

xlabel(ax3, "$x$", "Interpreter", "latex")
ylabel(ax3, "$p$", "Interpreter", "latex")
xlim(ax3, [x1,x2]);
ylim(ax3, [0,1800]);

legend(ax3, [hLF3; hxs13; hxs23; h03], ...
    [ ...
    "$p_1$", ...
    "$p_2$", ...
    "$p_3$", ...
...
set(ax3,'TickLabelInterpreter','latex','FontSize',FS, ...
    'LineWidth',0.9,'Box','off','Layer','top', ...
    'XMinorTick','on','YMinorTick','on')
ax3.GridAlpha = 0.15;
ax3.MinorGridAlpha = 0.08;
